...
function questGen() {
    ...
    const quest_motive = randomString(motivation);
...
function adventureGen() {
    const adventure_condition = randomString(condition);
    ...
    const adventure_place = randomString(place);
    const adventure_goal = randomString(goal);
    const adventure_motive = randomString(motivation);
    const adventure_twist = randomString(twist);
