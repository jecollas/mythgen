...
const nable = {
  ...
  g: [
    "lea","leaf","leb","lef","leff","leg","legg","lei","len","lenn","les","less","li","lia","liam","lias","lie","lin","ling","linn","lion","lis","lisa","lissa","lith","lli","llia","llo","llon","llow","llows","lo","lom","lon","long","lonn","lor","lorr","loud","low","lows","loz","lu","luck","luff","lund","lus","lux","ly","lys","ma","mab","mad","mag","mage","mal","mall","mam","man","mann","mant","mar","mari","mars","marsh","mas","mason","mass","mau","maur","may","me","mee","meh","mehr","mel","meli","mell","mer","merch","mesh","met","mett","meu","mez","mi","mil","mill","min","mir","mire","mis","miss","mist","mo","mol","mold","moll","mon"
  ],
  h: [
    "moo","moon","mor","moran","more","morr","mott","mour","mu","muck","muk","mul","mull","mum","mun","mund","munn","munt","mus","muss","my","myr","mys","myst","na","nae","naeg","naen","nah","nak","nal","nall","nam","nar","nay","ne","ned","nek","nel","nell","net","nett","ni","nic","nil","nill","nis","nit","nitt","no","noa","nob","nobb","noon","nor","nore","norr","nos","noss","not","nott","nox","nu","nus","ny","nya","nym","o","oa","oak","oar","ob","oc","od","odd","oe","of","off","og","ogma","oh","oi","ois","oj","ok","ol","old","oll","om","on","ond","one","ong","oni","oo","ood","ook","oon","op"
  ],
  i: [
    "opp","oq","oqu","or","ora","oran","ore","orm","orn","orne","oro","orr","orra","orran","orre","orro","os","osa","oss","ot","oth","other","ott","ou","oud","oun","our","ourke","ous","ouse","ouss","ov","ove","ow","owl","ows","ox","oy","oz","pa","pach","pal","pall","pam","pan","par","para","parr","pe","pei","pel","pell","pen","per","pera","perra","phan","phil","phin","phina","phyr","pi","po","por","porr","pos","poy","ppi","pres","press","pu","pul","pull","pus","puss","put","putt","py","qi","qu","qua","quas","que","qui","quill","quo","quy","ra","rad","radd","rag","rain","ral","rall","ralt","ram"
  ],
  j: [
    "ran","ranno","rano","rat","rate","ratt","ratz","ray","re","rea","reg","rel","rell","rem","ren","renn","reth","rey","rhi","rhin","rhine","rhinn","ri","ria","rial","riall","riar","rias","ric","rick","rid","ridd","ride","rider","ridge","rie","riel","riell","rielle","right","rik","ril","rill","rim","rin","rios","rious","ris","risse","rit","ritt","rius","rix","ro","roa","roar","roark","rob","rod","rol","roll","rom","ron","rook","rop","rope","rora","ros","ross","rot","roth","rott","row","rrin","rrow","ru","rua","rul","rull","rust","rut","ruth","rutt","ry","ryd","ryde","ryder","ryk","s","sa","sag","sage","sai","saige"
  ],
  k: [
    "sail","sal","sall","sam","san","sar","sarr","saul","say","sca","scan","se","seef","sef","sel","sell","seph","ser","sera","sh","sha","shal","shall","shar","sharp","shin","sho","si","sia","sic","sig","sih","sil","silver","sin","sirk","sit","sitt","sius","ska","sla","slat","slate","so","sol","soll","son","song","sopp","sou","sour","spar","sper","spor","ssaul","sta","stair","stal","star","ste","stee","sti","stil","still","sto","stone","stor","storm","storr","str","stra","strev","stry","su","sun","sur","surr","sy","ta","tac","tae","tal","tall","tan","tar","tars","tas","tass","tav","te","tek","tel","tell","tem","ter","th","tha"
  ],
  l: [
    "thad","tham","than","thann","thar","thari","tharr","thear","theo","ther","therr","they","thi","thia","thio","thion","tho","thon","thor","thorn","thorne","thr","thru","thrust","thur","thy","ti","tie","ties","tle","to","ton","tongue","tonn","tor","torr","tr","tra","trav","trax","tre","tred","tri","trig","tril","trill","tris","tru","ttle","tu","tue","tus","ty","u","ua","ub","uc","uck","ud","ue","uf","ug","uh","ui","uj","uk","ul","ulf","ull","um","un","undo","unn","uo","up","uq","uqu","ur","urt","us","usk","uss","ust","ut","utt","uv","uw","ux","uy","uz","va","vad","val","vall","vam","van","var"
  ],
  m: [
    "vas","vay","ve","veaux","ven","ver","vi","vic","vik","vil","vill","vit","vo","von","vri","vu","vy","wa","wahl","wal","walk","walker","wall","water","way","we","wen","when","whis","whisp","wi","wil","will","win","wo","wolf","woo","wood","wor","worth","wre","wren","wu","wul","wulf","wull","wy","wyll","wym","wyn","xa","xan","xe","xes","xi","xo","xu","y","ya","yal","yall","yam","yan","yax","ye","yi","yin","yo","yon","yr","yu","za","zah","zam","zar","zat","zav","zax","ze","zee","zeg","zegy","zep","zeph","zet","zett","zha","zhao","zi","zin","zo","zoa","zom","zu","zum","zy","zyr"
  ]
}
